...
export const contractsColumns = [
  ...
  { field: 'award_date', name: I18n.t('gobierto_visualizations.visualizations.contracts.contracts_show.awarding'), format: 'date', cssClass: 'nowrap pl1 right', type: 'date' },
  ...
  { field: 'open_proposals_date', name: I18n.t('gobierto_visualizations.visualizations.contracts.contracts_show.open_proposals_date'), format: 'date', cssClass: 'nowrap pl1', type: 'date' },
  { field: 'submission_date', name: I18n.t('gobierto_visualizations.visualizations.contracts.contracts_show.submission_date'), format: 'date', cssClass: 'nowrap pl1', type: 'date' },
...
export const tendersColumns = [
  ...
  { field: 'submission_date', translation: I18n.t('gobierto_visualizations.visualizations.contracts.submission_date'), format: 'date', type: 'date', cssClass: 'nowrap right' },
];
...
export const assigneesShowColumns = [
  ...
  { field: 'award_date', name: I18n.t('gobierto_visualizations.visualizations.contracts.date'), format: 'date', cssClass: 'nowrap pl1 right', type: 'date' },
];
